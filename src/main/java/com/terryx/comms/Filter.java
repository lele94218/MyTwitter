...
/**
 * Created by xueta on 2016/4/5 15:19.
 */
public class Filter implements Serializable {
    private static final long serialVersionUID = -7014169223617111354L;
     ...
     * @param value    值
     */
    protected Filter(String property, Operator operator, Object value) {
     ...
     */
    protected Filter(String property, Operator operator, Object value, boolean ignoreCase) {
        this.property = property;
        this.operator = operator;
        this.value = value;
